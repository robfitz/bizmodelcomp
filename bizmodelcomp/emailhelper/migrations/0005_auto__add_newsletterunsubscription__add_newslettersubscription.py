...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'NewsletterUnsubscription'
        db.create_table('emailhelper_newsletterunsubscription', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('subscription_timestamp', self.gf('django.db.models.fields.DateTimeField')()),
            ('unsubscription_timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('emailhelper', ['NewsletterUnsubscription'])

        # Adding model 'NewsletterSubscription'
        db.create_table('emailhelper_newslettersubscription', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('unsubscribe_key', self.gf('django.db.models.fields.CharField')(default='u6ogQ9ebKC', unique=True, max_length=10)),
            ('email', self.gf('django.db.models.fields.CharField')(max_length=100)),
            ('timestamp', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
        ))
        db.send_create_signal('emailhelper', ['NewsletterSubscription'])


    def backwards(self, orm):
        
        # Deleting model 'NewsletterUnsubscription'
        db.delete_table('emailhelper_newsletterunsubscription')

        # Deleting model 'NewsletterSubscription'
        db.delete_table('emailhelper_newslettersubscription')
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 12, 31, 15, 31, 42, 785218)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'emailhelper.newslettersubscription': {
            ...
            'unsubscribe_key': ('django.db.models.fields.CharField', [], {'default': "'u6ogQ9ebKC'", 'unique': 'True', 'max_length': '10'})
        },
