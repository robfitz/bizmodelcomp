...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Email_address'
        db.create_table('emailhelper_email_address', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('bulk_email', self.gf('django.db.models.fields.related.ForeignKey')(related_name='recipient_addresses', to=orm['emailhelper.Bulk_email'])),
            ('address', self.gf('django.db.models.fields.CharField')(max_length=140)),
        ))
        db.send_create_signal('emailhelper', ['Email_address'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'Email_address'
        db.delete_table('emailhelper_email_address')
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 12, 7, 18, 15, 13, 437770)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'emailhelper.email_address': {
            'Meta': {'object_name': 'Email_address'},
