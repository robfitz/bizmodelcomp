...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Bulk_email.competition'
        db.add_column('emailhelper_bulk_email', 'competition', self.gf('django.db.models.fields.related.ForeignKey')(default='1', to=orm['competition.Competition']), keep_default=False)

        # Adding field 'Bulk_email.phase'
        db.add_column('emailhelper_bulk_email', 'phase', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['competition.Phase'], null=True, blank=True), keep_default=False)

        # Adding field 'Bulk_email.tag'
        db.add_column('emailhelper_bulk_email', 'tag', self.gf('django.db.models.fields.CharField')(max_length=140, null=True, blank=True), keep_default=False)

        # Changing field 'Bulk_email.recipient_founders'
        db.alter_column('emailhelper_bulk_email', 'recipient_founders', self.gf('django.db.models.fields.CharField')(max_length=1000000))


    def backwards(self, orm):
        
        # Deleting field 'Bulk_email.competition'
        db.delete_column('emailhelper_bulk_email', 'competition_id')

        # Deleting field 'Bulk_email.phase'
        db.delete_column('emailhelper_bulk_email', 'phase_id')

        # Deleting field 'Bulk_email.tag'
        db.delete_column('emailhelper_bulk_email', 'tag')

        # Changing field 'Bulk_email.recipient_founders'
        db.alter_column('emailhelper_bulk_email', 'recipient_founders', self.gf('django.db.models.fields.CharField')(max_length=10000))
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 12, 5, 6, 23, 58, 804072)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
