...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Email_address.user'
        db.add_column('emailhelper_email_address', 'user', self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['auth.User'], null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Email_address.user'
        db.delete_column('emailhelper_email_address', 'user_id')
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 12, 7, 20, 59, 32, 472487)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
