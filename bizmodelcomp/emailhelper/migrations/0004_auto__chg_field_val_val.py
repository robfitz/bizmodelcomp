...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Val.val'
        db.alter_column('emailhelper_val', 'val', self.gf('django.db.models.fields.CharField')(max_length=10000))


    def backwards(self, orm):
        
        # Changing field 'Val.val'
        db.alter_column('emailhelper_val', 'val', self.gf('django.db.models.fields.CharField')(max_length=500))
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 12, 16, 16, 22, 38, 509456)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
