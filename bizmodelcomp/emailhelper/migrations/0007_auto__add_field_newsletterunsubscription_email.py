...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'NewsletterUnsubscription.email'
        db.add_column('emailhelper_newsletterunsubscription', 'email', self.gf('django.db.models.fields.CharField')(default='', max_length=100), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'NewsletterUnsubscription.email'
        db.delete_column('emailhelper_newsletterunsubscription', 'email')
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 12, 31, 15, 51, 54, 655734)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'emailhelper.newslettersubscription': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'timestamp': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'unsubscribe_key': ('django.db.models.fields.CharField', [], {'default': "'znf2II8P6W'", 'unique': 'True', 'max_length': '10'})
        },
