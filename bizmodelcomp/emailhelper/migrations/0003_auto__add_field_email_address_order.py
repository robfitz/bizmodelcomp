...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Email_address.order'
        db.add_column('emailhelper_email_address', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Email_address.order'
        db.delete_column('emailhelper_email_address', 'order')
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 12, 16, 14, 20, 43, 62733)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
