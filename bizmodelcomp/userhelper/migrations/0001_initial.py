...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('userhelper_verificationkey', (
            ('key', self.gf('django.db.models.fields.CharField')(max_length=20, primary_key=True)),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], unique=True)),
            ('is_verified', self.gf('django.db.models.fields.BooleanField')(default=True)),
        ))
        db.send_create_signal('userhelper', ['VerificationKey'])


    def backwards(self, orm):
        
        # Deleting model 'VerificationKey'
        db.delete_table('userhelper_verificationkey')
