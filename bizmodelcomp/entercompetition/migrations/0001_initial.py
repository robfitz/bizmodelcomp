...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'RandomFounderUrl'
        db.create_table('entercompetition_randomfounderurl', (
            ...
            ('temp_password', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('entercompetition', ['RandomFounderUrl'])


    def backwards(self, orm):
        
        # Deleting model 'RandomFounderUrl'
        db.delete_table('entercompetition_randomfounderurl')
    ...
    models = {
        ...
        'entercompetition.randomfounderurl': {
            'Meta': {'object_name': 'RandomFounderUrl'},
            ...
            'temp_password': ('django.db.models.fields.CharField', [], {'max_length': '100'})
        }
    }

    complete_apps = ['entercompetition']
