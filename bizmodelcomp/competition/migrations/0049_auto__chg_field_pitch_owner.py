...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Pitch.owner'
        db.alter_column('competition_pitch', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['competition.Founder'], null=True))


    def backwards(self, orm):
        
        # Changing field 'Pitch.owner'
        db.alter_column('competition_pitch', 'owner_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['competition.Founder']))
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 17, 14, 42, 37, 240517)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
