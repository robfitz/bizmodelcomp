...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PitchQuestion.field_rows'
        db.add_column('competition_pitchquestion', 'field_rows', self.gf('django.db.models.fields.IntegerField')(default=6), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PitchQuestion.field_rows'
        db.delete_column('competition_pitchquestion', 'field_rows')
