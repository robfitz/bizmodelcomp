...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Phase.scoring_tooltip'
        db.add_column('competition_phase', 'scoring_tooltip', self.gf('django.db.models.fields.CharField')(default='0 points means a completely missing or invalid answer. 1 point is an attempted but very bad answer. Maximum points means you would be pleased to see this answer in a professional pitch.', max_length=500, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Phase.scoring_tooltip'
        db.delete_column('competition_phase', 'scoring_tooltip')
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 4, 1, 45, 47, 699596)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
