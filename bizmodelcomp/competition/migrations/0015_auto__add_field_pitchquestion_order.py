...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PitchQuestion.order'
        db.add_column('competition_pitchquestion', 'order', self.gf('django.db.models.fields.DecimalField')(default=1, max_digits=4, decimal_places=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PitchQuestion.order'
        db.delete_column('competition_pitchquestion', 'order')
