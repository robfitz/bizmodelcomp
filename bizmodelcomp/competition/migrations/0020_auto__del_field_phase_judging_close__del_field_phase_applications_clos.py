...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        db.add_column('competition_phase', 'judging_close', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2010, 10, 29, 4, 41, 8, 974000)), keep_default=False)

        # Adding field 'Phase.applications_close_judging_open'
        db.add_column('competition_phase', 'applications_close_judging_open', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2010, 10, 29, 4, 41, 13, 416000)), keep_default=False)

        # Adding field 'Phase.applications_open'
        db.add_column('competition_phase', 'applications_open', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime(2010, 10, 29, 4, 41, 16, 688000)), keep_default=False)
