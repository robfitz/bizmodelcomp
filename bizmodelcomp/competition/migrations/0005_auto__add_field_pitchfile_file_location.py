...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PitchFile.file_location'
        db.add_column('competition_pitchfile', 'file_location', self.gf('django.db.models.fields.CharField')(default='default', max_length=500), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PitchFile.file_location'
        db.delete_column('competition_pitchfile', 'file_location')
