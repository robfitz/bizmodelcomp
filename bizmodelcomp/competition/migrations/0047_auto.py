...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field other_requirements on 'ApplicationRequirements'
        db.create_table('competition_applicationrequirements_other_requirements', (
        ...
        db.create_unique('competition_applicationrequirements_other_requirements', ['applicationrequirements_id', 'tag_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field other_requirements on 'ApplicationRequirements'
        db.delete_table('competition_applicationrequirements_other_requirements')
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 8, 18, 28, 35, 314176)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
