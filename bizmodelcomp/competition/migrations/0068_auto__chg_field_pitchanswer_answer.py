...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'PitchAnswer.answer'
        db.alter_column('competition_pitchanswer', 'answer', self.gf('django.db.models.fields.CharField')(max_length=4000))


    def backwards(self, orm):
        
        # Changing field 'PitchAnswer.answer'
        db.alter_column('competition_pitchanswer', 'answer', self.gf('django.db.models.fields.CharField')(max_length=2000))
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 10, 0, 11, 24, 893240)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
