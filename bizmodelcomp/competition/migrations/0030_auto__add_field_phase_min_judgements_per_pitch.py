...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Phase.min_judgements_per_pitch'
        db.add_column('competition_phase', 'min_judgements_per_pitch', self.gf('django.db.models.fields.IntegerField')(default=2), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Phase.min_judgements_per_pitch'
        db.delete_column('competition_phase', 'min_judgements_per_pitch')
