...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Competition.logo'
        db.add_column('competition_competition', 'logo', self.gf('django.db.models.fields.files.FileField')(max_length=100, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Competition.logo'
        db.delete_column('competition_competition', 'logo')
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 12, 5, 1, 7, 39, 586291)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
