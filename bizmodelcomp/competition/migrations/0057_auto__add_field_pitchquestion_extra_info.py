...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PitchQuestion.extra_info'
        db.add_column('competition_pitchquestion', 'extra_info', self.gf('django.db.models.fields.CharField')(default='', max_length=1000, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PitchQuestion.extra_info'
        db.delete_column('competition_pitchquestion', 'extra_info')
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 21, 19, 16, 39, 435376)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
