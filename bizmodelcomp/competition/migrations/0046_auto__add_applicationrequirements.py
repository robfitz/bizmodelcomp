...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ApplicationRequirements'
        db.create_table('competition_applicationrequirements', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('competition', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['competition.Competition'], unique=True, null=True, blank=True)),
        ))
        db.send_create_signal('competition', ['ApplicationRequirements'])

        # Adding M2M table for field business_types on 'ApplicationRequirements'
        db.create_table('competition_applicationrequirements_business_types', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('applicationrequirements', models.ForeignKey(orm['competition.applicationrequirements'], null=False)),
            ('tag', models.ForeignKey(orm['utils.tag'], null=False))
        ))
        db.create_unique('competition_applicationrequirements_business_types', ['applicationrequirements_id', 'tag_id'])

        # Adding M2M table for field applicant_types on 'ApplicationRequirements'
        db.create_table('competition_applicationrequirements_applicant_types', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('applicationrequirements', models.ForeignKey(orm['competition.applicationrequirements'], null=False)),
            ('tag', models.ForeignKey(orm['utils.tag'], null=False))
        ))
        db.create_unique('competition_applicationrequirements_applicant_types', ['applicationrequirements_id', 'tag_id'])

        # Adding M2M table for field institutions on 'ApplicationRequirements'
        db.create_table('competition_applicationrequirements_institutions', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('applicationrequirements', models.ForeignKey(orm['competition.applicationrequirements'], null=False)),
            ('tag', models.ForeignKey(orm['utils.tag'], null=False))
        ))
        db.create_unique('competition_applicationrequirements_institutions', ['applicationrequirements_id', 'tag_id'])

        # Adding M2M table for field locations on 'ApplicationRequirements'
        db.create_table('competition_applicationrequirements_locations', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('applicationrequirements', models.ForeignKey(orm['competition.applicationrequirements'], null=False)),
            ('tag', models.ForeignKey(orm['utils.tag'], null=False))
        ))
        db.create_unique('competition_applicationrequirements_locations', ['applicationrequirements_id', 'tag_id'])


    def backwards(self, orm):
        
        # Deleting model 'ApplicationRequirements'
        db.delete_table('competition_applicationrequirements')

        # Removing M2M table for field business_types on 'ApplicationRequirements'
        db.delete_table('competition_applicationrequirements_business_types')

        # Removing M2M table for field applicant_types on 'ApplicationRequirements'
        db.delete_table('competition_applicationrequirements_applicant_types')

        # Removing M2M table for field institutions on 'ApplicationRequirements'
        db.delete_table('competition_applicationrequirements_institutions')

        # Removing M2M table for field locations on 'ApplicationRequirements'
        db.delete_table('competition_applicationrequirements_locations')
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 6, 2, 56, 41, 242815)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
