...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Competition.template_pitch'
        db.alter_column('competition_competition', 'template_pitch', self.gf('django.db.models.fields.CharField')(max_length=201))


    def backwards(self, orm):
        
        # Changing field 'Competition.template_pitch'
        db.alter_column('competition_competition', 'template_pitch', self.gf('django.db.models.fields.CharField')(max_length=200))
