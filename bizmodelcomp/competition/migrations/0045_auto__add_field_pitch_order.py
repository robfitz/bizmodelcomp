...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('competition_pitch', 'order', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Pitch.order'
        db.delete_column('competition_pitch', 'order')
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 12, 13, 18, 13, 0, 764827)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
