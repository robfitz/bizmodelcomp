...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Phase.is_deleted'
        db.add_column('competition_phase', 'is_deleted', self.gf('django.db.models.fields.BooleanField')(default=False))


    def backwards(self, orm):
        
        # Deleting field 'Phase.is_deleted'
        db.delete_column('competition_phase', 'is_deleted')
