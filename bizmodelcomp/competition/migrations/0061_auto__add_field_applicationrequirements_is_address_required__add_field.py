...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'ApplicationRequirements.is_address_required'
        db.add_column('competition_applicationrequirements', 'is_address_required', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ApplicationRequirements.is_birthday_required'
        db.add_column('competition_applicationrequirements', 'is_birthday_required', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ApplicationRequirements.is_phone_required'
        db.add_column('competition_applicationrequirements', 'is_phone_required', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ApplicationRequirements.is_institution_required'
        db.add_column('competition_applicationrequirements', 'is_institution_required', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ApplicationRequirements.is_course_of_study_required'
        db.add_column('competition_applicationrequirements', 'is_course_of_study_required', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding field 'ApplicationRequirements.is_year_of_study_required'
        db.add_column('competition_applicationrequirements', 'is_year_of_study_required', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'ApplicationRequirements.is_address_required'
        db.delete_column('competition_applicationrequirements', 'is_address_required')

        # Deleting field 'ApplicationRequirements.is_birthday_required'
        db.delete_column('competition_applicationrequirements', 'is_birthday_required')

        # Deleting field 'ApplicationRequirements.is_phone_required'
        db.delete_column('competition_applicationrequirements', 'is_phone_required')

        # Deleting field 'ApplicationRequirements.is_institution_required'
        db.delete_column('competition_applicationrequirements', 'is_institution_required')

        # Deleting field 'ApplicationRequirements.is_course_of_study_required'
        db.delete_column('competition_applicationrequirements', 'is_course_of_study_required')

        # Deleting field 'ApplicationRequirements.is_year_of_study_required'
        db.delete_column('competition_applicationrequirements', 'is_year_of_study_required')
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 28, 11, 1, 10, 143791)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
