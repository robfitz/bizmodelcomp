...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PitchQuestion.is_divider'
        db.add_column('competition_pitchquestion', 'is_divider', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PitchQuestion.is_divider'
        db.delete_column('competition_pitchquestion', 'is_divider')
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 20, 18, 39, 52, 120087)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
