...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Competition.hex_header_color'
        db.add_column('competition_competition', 'hex_header_color', self.gf('django.db.models.fields.CharField')(default='', max_length=6, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Competition.hex_header_color'
        db.delete_column('competition_competition', 'hex_header_color')
    ...
    models = {
        ...
        'competition.competition': {
            ...
            'template_base': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '200'}),
            'template_pitch': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '201'}),
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 27, 20, 5, 50, 645049)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
