...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PitchQuestion.is_hidden_from_applicants'
        db.add_column('competition_pitchquestion', 'is_hidden_from_applicants', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Changing field 'PitchQuestion.raw_choices'
        db.alter_column('competition_pitchquestion', 'raw_choices', self.gf('django.db.models.fields.CharField')(max_length=2000))
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PitchQuestion.is_hidden_from_applicants'
        db.delete_column('competition_pitchquestion', 'is_hidden_from_applicants')

        # Changing field 'PitchQuestion.raw_choices'
        db.alter_column('competition_pitchquestion', 'raw_choices', self.gf('django.db.models.fields.CharField')(max_length=2000, null=True))
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 24, 12, 9, 15, 961000)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
