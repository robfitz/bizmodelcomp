...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Founder', fields ['email']
        db.delete_unique('competition_founder', ['email'])
        ...
        db.create_table('competition_anonymousteamkey', (
            ...
            ('founder', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['competition.Team'], unique=True)),
        ))
        db.send_create_signal('competition', ['AnonymousTeamKey'])

        # Changing field 'Founder.email'
        db.alter_column('competition_founder', 'email', self.gf('django.db.models.fields.CharField')(max_length=255, null=True))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Founder.email'
        db.alter_column('competition_founder', 'email', self.gf('django.db.models.fields.CharField')(max_length=255, unique=True))

        # Adding unique constraint on 'Founder', fields ['email']
        db.create_unique('competition_founder', ['email'])
    ...
    models = {
        ...
        'competition.anonymousteamkey': {
            'Meta': {'object_name': 'AnonymousTeamKey'},
            'founder': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['competition.Team']", 'unique': 'True'}),
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 17, 19, 0, 55, 161356)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
