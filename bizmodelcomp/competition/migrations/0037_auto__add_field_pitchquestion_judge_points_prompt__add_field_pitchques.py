...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PitchQuestion.judge_points_prompt'
        db.add_column('competition_pitchquestion', 'judge_points_prompt', self.gf('django.db.models.fields.CharField')(default='', max_length=140), keep_default=False)

        # Adding field 'PitchQuestion.judge_feedback_prompt'
        db.add_column('competition_pitchquestion', 'judge_feedback_prompt', self.gf('django.db.models.fields.CharField')(default='', max_length=140), keep_default=False)

        # Changing field 'PitchQuestion.prompt'
        db.alter_column('competition_pitchquestion', 'prompt', self.gf('django.db.models.fields.CharField')(max_length=1000, null=True))


    def backwards(self, orm):
        
        # Deleting field 'PitchQuestion.judge_points_prompt'
        db.delete_column('competition_pitchquestion', 'judge_points_prompt')

        # Deleting field 'PitchQuestion.judge_feedback_prompt'
        db.delete_column('competition_pitchquestion', 'judge_feedback_prompt')

        # Changing field 'PitchQuestion.prompt'
        db.alter_column('competition_pitchquestion', 'prompt', self.gf('django.db.models.fields.CharField')(max_length=1000))
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 21, 20, 10, 44, 200000)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'competition.pitchquestion': {
            ...
            'prompt': ('django.db.models.fields.CharField', [], {'max_length': '1000', 'null': 'True', 'blank': 'True'}),
