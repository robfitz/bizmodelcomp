...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Phase.is_applications_closed'
        db.add_column('competition_phase', 'is_applications_closed', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Phase.is_applications_closed'
        db.delete_column('competition_phase', 'is_applications_closed')
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 21, 14, 32, 14, 151183)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_applications_closed': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
