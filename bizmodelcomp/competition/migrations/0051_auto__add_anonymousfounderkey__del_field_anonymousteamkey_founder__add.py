...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'AnonymousTeamKey.founder'
        db.delete_column('competition_anonymousteamkey', 'founder_id')

        # Adding field 'AnonymousTeamKey.team'
        db.add_column('competition_anonymousteamkey', 'team', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['competition.Team'], unique=True, null=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Adding field 'AnonymousTeamKey.founder'
        db.add_column('competition_anonymousteamkey', 'founder', self.gf('django.db.models.fields.related.OneToOneField')(default=None, to=orm['competition.Team'], unique=True), keep_default=False)

        # Deleting field 'AnonymousTeamKey.team'
        db.delete_column('competition_anonymousteamkey', 'team_id')
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 18, 21, 33, 37, 465232)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
