...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Competition.template_base'
        db.add_column('competition_competition', 'template_base', self.gf('django.db.models.fields.CharField')(default='base.html', max_length=200), keep_default=False)

        # Adding field 'Competition.template_stylesheet'
        db.add_column('competition_competition', 'template_stylesheet', self.gf('django.db.models.fields.CharField')(default='', max_length=200, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Competition.template_base'
        db.delete_column('competition_competition', 'template_base')

        # Deleting field 'Competition.template_stylesheet'
        db.delete_column('competition_competition', 'template_stylesheet')
    ...
    models = {
        ...
        'competition.founder': {
            ...
            'email': ('django.db.models.fields.CharField', [], {'max_length': '500', 'unique': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'competition.pitchquestion': {
            'Meta': {'ordering': "['id']", 'object_name': 'PitchQuestion'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'phase': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['competition.Phase']"}),
            'prompt': ('django.db.models.fields.CharField', [], {'max_length': '1000'}),
