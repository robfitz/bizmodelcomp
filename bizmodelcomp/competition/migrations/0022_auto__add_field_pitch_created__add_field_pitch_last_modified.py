...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Pitch.created'
        db.add_column('competition_pitch', 'created', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now_add=True, blank=True), keep_default=False)

        # Adding field 'Pitch.last_modified'
        db.add_column('competition_pitch', 'last_modified', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, auto_now=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Pitch.created'
        db.delete_column('competition_pitch', 'created')

        # Deleting field 'Pitch.last_modified'
        db.delete_column('competition_pitch', 'last_modified')
