...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PitchQuestion.is_required'
        db.add_column('competition_pitchquestion', 'is_required', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PitchQuestion.is_required'
        db.delete_column('competition_pitchquestion', 'is_required')
