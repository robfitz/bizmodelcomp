...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.alter_column('competition_phase', 'deadline', self.gf('django.db.models.fields.DateTimeField')())
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 20, 18, 57, 22, 989000)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
