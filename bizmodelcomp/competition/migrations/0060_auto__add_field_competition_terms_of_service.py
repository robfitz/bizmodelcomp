...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Competition.terms_of_service'
        db.add_column('competition_competition', 'terms_of_service', self.gf('django.db.models.fields.CharField')(default='', max_length=10000, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Competition.terms_of_service'
        db.delete_column('competition_competition', 'terms_of_service')
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 28, 1, 34, 32, 534318)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
