...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PitchQuestion.max_points'
        db.add_column('competition_pitchquestion', 'max_points', self.gf('django.db.models.fields.IntegerField')(default=10), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PitchQuestion.max_points'
        db.delete_column('competition_pitchquestion', 'max_points')
