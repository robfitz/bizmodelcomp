...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Founder.address'
        db.add_column('competition_founder', 'address', self.gf('django.db.models.fields.CharField')(default='', max_length=500, null=True, blank=True), keep_default=False)

        # Adding field 'Founder.course_of_study'
        db.add_column('competition_founder', 'course_of_study', self.gf('django.db.models.fields.CharField')(default='', max_length=500, null=True, blank=True), keep_default=False)

        # Adding field 'Founder.year_of_study'
        db.add_column('competition_founder', 'year_of_study', self.gf('django.db.models.fields.CharField')(default='', max_length=100, null=True, blank=True), keep_default=False)

        # Changing field 'Founder.birth'
        db.alter_column('competition_founder', 'birth', self.gf('django.db.models.fields.CharField')(max_length=50, null=True))


    def backwards(self, orm):
        
        # Deleting field 'Founder.address'
        db.delete_column('competition_founder', 'address')

        # Deleting field 'Founder.course_of_study'
        db.delete_column('competition_founder', 'course_of_study')

        # Deleting field 'Founder.year_of_study'
        db.delete_column('competition_founder', 'year_of_study')

        # Changing field 'Founder.birth'
        db.alter_column('competition_founder', 'birth', self.gf('django.db.models.fields.CharField')(max_length=10, null=True))
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 28, 11, 11, 26, 613867)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
