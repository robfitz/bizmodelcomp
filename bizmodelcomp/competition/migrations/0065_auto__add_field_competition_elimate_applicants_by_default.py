...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Competition.elimate_applicants_by_default'
        db.add_column('competition_competition', 'elimate_applicants_by_default', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Competition.elimate_applicants_by_default'
        db.delete_column('competition_competition', 'elimate_applicants_by_default')
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 16, 14, 51, 39, 793769)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
