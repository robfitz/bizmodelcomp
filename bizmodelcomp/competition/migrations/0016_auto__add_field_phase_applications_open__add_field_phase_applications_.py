...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('competition_phase', 'applications_open', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2010, 10, 29), blank=True), keep_default=False)

        # Adding field 'Phase.applications_close_judging_open'
        db.add_column('competition_phase', 'applications_close_judging_open', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2010, 10, 29), blank=True), keep_default=False)

        # Adding field 'Phase.judging_close'
        db.add_column('competition_phase', 'judging_close', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, default=datetime.date(2010, 10, 29), blank=True), keep_default=False)
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'applications_close_judging_open': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'applications_open': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'competition': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['competition.Competition']"}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'judging_close': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'name': ('django.db.models.fields.CharField', [], {'default': "''", 'max_length': '500', 'blank': 'True'})
        },
        'competition.pitch': {
