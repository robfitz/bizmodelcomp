...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column('competition_phase', 'online_applications_due', 'deadline')

        # Adding field 'Phase.pitch_type'
        db.add_column('competition_phase', 'pitch_type', self.gf('django.db.models.fields.CharField')(default='online', max_length=20), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Phase.deadline'
        db.rename_column('competition_phase', 'deadline', 'online_applications_due')

        # Deleting field 'Phase.pitch_type'
        db.delete_column('competition_phase', 'pitch_type')
