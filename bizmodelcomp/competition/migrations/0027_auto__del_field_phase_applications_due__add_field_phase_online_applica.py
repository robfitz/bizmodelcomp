...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column('competition_phase', 'applications_due', 'online_applications_due')

        # Adding field 'Competition.current_phase'
        db.add_column('competition_competition', 'current_phase', self.gf('django.db.models.fields.related.OneToOneField')(blank=True, related_name='competition_unused', unique=True, null=True, to=orm['competition.Phase']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Phase.online_applications_due'
        db.rename_column('competition_phase', 'online_applications_due', 'applications_due')

        # Deleting field 'Competition.current_phase'
        db.delete_column('competition_competition', 'current_phase_id')
