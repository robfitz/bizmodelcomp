...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'Prize'
        db.create_table('competition_prize', (
            ...
            ('money', self.gf('django.db.models.fields.IntegerField')(default=0, null=True, blank=True)),
            ('currency', self.gf('django.db.models.fields.CharField')(default='$', max_length=10)),
        ))
        db.send_create_signal('competition', ['Prize'])

        # Adding field 'Pitch.result'
        db.add_column('competition_pitch', 'result', self.gf('django.db.models.fields.CharField')(default='Default', max_length=50), keep_default=False)

        # Adding M2M table for field tags on 'Pitch'
        db.create_table('competition_pitch_tags', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('pitch', models.ForeignKey(orm['competition.pitch'], null=False)),
            ('pitchtag', models.ForeignKey(orm['utils.pitchtag'], null=False))
        ))
        db.create_unique('competition_pitch_tags', ['pitch_id', 'pitchtag_id'])


    def backwards(self, orm):
        
        # Deleting model 'Prize'
        db.delete_table('competition_prize')

        # Deleting field 'Pitch.result'
        db.delete_column('competition_pitch', 'result')

        # Removing M2M table for field tags on 'Pitch'
        db.delete_table('competition_pitch_tags')
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 16, 13, 16, 44, 583449)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'competition.pitch': {
            ...
            'tags': ('django.db.models.fields.related.ManyToManyField', [], {'related_name': "'pitches'", 'symmetrical': 'False', 'to': "orm['utils.PitchTag']"}),
        ...
        'utils.pitchtag': {
            'Meta': {'object_name': 'PitchTag'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_standard': ('django.db.models.fields.BooleanField', [], {'default': 'False'}),
            'name': ('django.db.models.fields.CharField', [], {'max_length': '50'})
        },
        'utils.tag': {
