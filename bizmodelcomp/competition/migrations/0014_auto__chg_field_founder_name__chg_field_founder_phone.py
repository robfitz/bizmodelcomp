...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Founder.name'
        db.alter_column('competition_founder', 'name', self.gf('django.db.models.fields.CharField')(max_length=500, null=True))

        # Changing field 'Founder.phone'
        db.alter_column('competition_founder', 'phone', self.gf('django.db.models.fields.CharField')(max_length=20, null=True))


    def backwards(self, orm):
        
        # Changing field 'Founder.name'
        db.alter_column('competition_founder', 'name', self.gf('django.db.models.fields.CharField')(max_length=500))

        # Changing field 'Founder.phone'
        db.alter_column('competition_founder', 'phone', self.gf('django.db.models.fields.CharField')(max_length=20))
