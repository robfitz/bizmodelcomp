...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Competition.template_pitch'
        db.add_column('competition_competition', 'template_pitch', self.gf('django.db.models.fields.CharField')(default='pitch_form.html', max_length=200), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Competition.template_pitch'
        db.delete_column('competition_competition', 'template_pitch')
    ...
    models = {
        ...
        'competition.competition': {
            ...
            'template_pitch': ('django.db.models.fields.CharField', [], {'default': "'pitch_form.html'", 'max_length': '200'}),
