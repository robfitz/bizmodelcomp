...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Phase.is_judging_enabled'
        db.add_column('competition_phase', 'is_judging_enabled', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Phase.is_judging_enabled'
        db.delete_column('competition_phase', 'is_judging_enabled')
