...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Pitch.is_draft'
        db.add_column('competition_pitch', 'is_draft', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Pitch.is_draft'
        db.delete_column('competition_pitch', 'is_draft')
