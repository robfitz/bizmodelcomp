...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PitchQuestion.max_answer_words'
        db.add_column('competition_pitchquestion', 'max_answer_words', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'PitchQuestion.max_answer_words'
        db.delete_column('competition_pitchquestion', 'max_answer_words')
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 9, 23, 35, 27, 949998)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
