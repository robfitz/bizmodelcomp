...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'Phase.current_status'
        db.delete_column('competition_phase', 'current_status')
        ...
        # Deleting field 'Competition.setup_step'
        db.delete_column('competition_competition', 'setup_step')


    def backwards(self, orm):
        
        # Adding field 'Phase.current_status'
        db.add_column('competition_phase', 'current_status', self.gf('django.db.models.fields.CharField')(default='pending', max_length=140), keep_default=False)

        # Deleting field 'Phase.setup_step'
        db.delete_column('competition_phase', 'setup_step')

        # Adding field 'Competition.setup_step'
        db.add_column('competition_competition', 'setup_step', self.gf('django.db.models.fields.IntegerField')(default=1), keep_default=False)
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 25, 0, 32, 5, 8000)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'setup_step': ('django.db.models.fields.IntegerField', [], {'default': '0'})
        },
        'competition.pitch': {
