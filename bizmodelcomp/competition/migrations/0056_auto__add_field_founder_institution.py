...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Founder.institution'
        db.add_column('competition_founder', 'institution', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='founder_institution', null=True, to=orm['utils.Tag']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Founder.institution'
        db.delete_column('competition_founder', 'institution_id')
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 21, 17, 40, 55, 567828)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
