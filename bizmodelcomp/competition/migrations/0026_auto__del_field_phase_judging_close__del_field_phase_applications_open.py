...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.rename_column('competition_phase', 'applications_close_judging_open', 'online_applications_due')

        # Changing field 'Phase.name'
        db.alter_column('competition_phase', 'name', self.gf('django.db.models.fields.CharField')(max_length=140))


    def backwards(self, orm):
        
        # Adding field 'Phase.judging_close'
        db.add_column('competition_phase', 'judging_close', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)

        # Adding field 'Phase.applications_open'
        db.add_column('competition_phase', 'applications_open', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now), keep_default=False)
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'applications_due': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime.now'}),
