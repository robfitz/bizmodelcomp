...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'PhaseSetupSteps.sent_feedback'
        db.add_column('competition_phasesetupsteps', 'sent_feedback', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'PhaseSetupSteps.sent_feedback'
        db.delete_column('competition_phasesetupsteps', 'sent_feedback')
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 26, 19, 47, 3, 900880)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
