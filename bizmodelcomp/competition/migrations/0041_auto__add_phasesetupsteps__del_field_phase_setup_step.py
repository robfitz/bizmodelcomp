...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'PhaseSetupSteps'
        db.create_table('competition_phasesetupsteps', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('phase', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['competition.Phase'], unique=True)),
            ('details_confirmed', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('application_setup', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('announced_applications', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('invited_judges', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('announced_judging_open', self.gf('django.db.models.fields.BooleanField')(default=False)),
            ('selected_winners', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('competition', ['PhaseSetupSteps'])

        # Deleting field 'Phase.setup_step'
        db.delete_column('competition_phase', 'setup_step')


    def backwards(self, orm):
        
        # Deleting model 'PhaseSetupSteps'
        db.delete_table('competition_phasesetupsteps')

        # Adding field 'Phase.setup_step'
        db.add_column('competition_phase', 'setup_step', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 25, 6, 58, 2, 795000)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
