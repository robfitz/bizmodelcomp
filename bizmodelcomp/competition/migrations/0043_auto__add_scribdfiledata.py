...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ScribdFileData'
        db.create_table('competition_scribdfiledata', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('pitch_file', self.gf('django.db.models.fields.related.OneToOneField')(related_name='scribd_file_data', unique=True, to=orm['competition.PitchFile'])),
            ...
            ('secret_password', self.gf('django.db.models.fields.CharField')(max_length=100)),
        ))
        db.send_create_signal('competition', ['ScribdFileData'])


    def backwards(self, orm):
        
        # Deleting model 'ScribdFileData'
        db.delete_table('competition_scribdfiledata')
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 12, 5, 13, 50, 33, 773)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
