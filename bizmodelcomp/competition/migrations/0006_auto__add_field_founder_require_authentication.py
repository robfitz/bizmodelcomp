...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Founder.require_authentication'
        db.add_column('competition_founder', 'require_authentication', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Founder.require_authentication'
        db.delete_column('competition_founder', 'require_authentication')
