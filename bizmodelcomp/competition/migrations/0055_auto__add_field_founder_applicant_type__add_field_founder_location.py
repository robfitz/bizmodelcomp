...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Founder.applicant_type'
        db.add_column('competition_founder', 'applicant_type', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='founder_applicant_type', null=True, to=orm['utils.Tag']), keep_default=False)

        # Adding field 'Founder.location'
        db.add_column('competition_founder', 'location', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='founder_location', null=True, to=orm['utils.Tag']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'Founder.applicant_type'
        db.delete_column('competition_founder', 'applicant_type_id')

        # Deleting field 'Founder.location'
        db.delete_column('competition_founder', 'location_id')
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 21, 17, 26, 35, 494899)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
