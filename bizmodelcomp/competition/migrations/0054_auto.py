...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field business_types on 'Team'
        db.create_table('competition_team_business_types', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('team', models.ForeignKey(orm['competition.team'], null=False)),
            ('tag', models.ForeignKey(orm['utils.tag'], null=False))
        ))
        db.create_unique('competition_team_business_types', ['team_id', 'tag_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field business_types on 'Team'
        db.delete_table('competition_team_business_types')
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 1, 20, 22, 7, 42, 701826)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
