...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Phase.deadline'
        db.alter_column('competition_phase', 'deadline', self.gf('django.db.models.fields.DateTimeField')(max_length=100))


    def backwards(self, orm):
        
        # Changing field 'Phase.deadline'
        db.alter_column('competition_phase', 'deadline', self.gf('django.db.models.fields.IntegerField')())
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 20, 18, 47, 5, 518000)', 'max_length': '100'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
