...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Phase.judging_close'
        db.alter_column('competition_phase', 'judging_close', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Phase.applications_close_judging_open'
        db.alter_column('competition_phase', 'applications_close_judging_open', self.gf('django.db.models.fields.DateTimeField')())

        # Changing field 'Phase.applications_open'
        db.alter_column('competition_phase', 'applications_open', self.gf('django.db.models.fields.DateTimeField')())


    def backwards(self, orm):
        
        # Changing field 'Phase.judging_close'
        db.alter_column('competition_phase', 'judging_close', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Phase.applications_close_judging_open'
        db.alter_column('competition_phase', 'applications_close_judging_open', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))

        # Changing field 'Phase.applications_open'
        db.alter_column('competition_phase', 'applications_open', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True))
