...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'JudgingCriteria.scoring_tooltip'
        db.add_column('judge_judgingcriteria', 'scoring_tooltip', self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'JudgingCriteria.scoring_tooltip'
        db.delete_column('judge_judgingcriteria', 'scoring_tooltip')
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 4, 1, 42, 23, 69451)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
