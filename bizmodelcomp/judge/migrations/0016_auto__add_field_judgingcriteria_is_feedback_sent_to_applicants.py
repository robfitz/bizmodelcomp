...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'JudgingCriteria.is_feedback_sent_to_applicants'
        db.add_column('judge_judgingcriteria', 'is_feedback_sent_to_applicants', self.gf('django.db.models.fields.BooleanField')(default=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'JudgingCriteria.is_feedback_sent_to_applicants'
        db.delete_column('judge_judgingcriteria', 'is_feedback_sent_to_applicants')
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 26, 19, 47, 12, 571639)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
        ...
        'judge.judgingcriteria': {
            'Meta': {'ordering': "['order']", 'object_name': 'JudgingCriteria'},
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'is_feedback_sent_to_applicants': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
