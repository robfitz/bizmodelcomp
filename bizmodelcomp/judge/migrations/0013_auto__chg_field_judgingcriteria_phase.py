...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'JudgingCriteria.phase'
        db.alter_column('judge_judgingcriteria', 'phase_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['competition.Phase'], null=True))


    def backwards(self, orm):
        
        # Changing field 'JudgingCriteria.phase'
        db.alter_column('judge_judgingcriteria', 'phase_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['competition.Phase']))
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 1, 17, 2, 7, 942271)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
