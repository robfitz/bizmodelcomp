...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column('judge_judgingcriteria', 'phase', self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['competition.Phase']), keep_default=False)
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'JudgingCriteria.phase'
        db.delete_column('judge_judgingcriteria', 'phase_id')

        # Deleting field 'JudgingCriteria.order'
        db.delete_column('judge_judgingcriteria', 'order')
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 1, 17, 1, 13, 76256)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
