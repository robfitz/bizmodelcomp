...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'JudgedPitch.overall_score'
        db.add_column('judge_judgedpitch', 'overall_score', self.gf('django.db.models.fields.IntegerField')(default=0), keep_default=False)

        # Adding field 'JudgedPitch.max_overall_score'
        db.add_column('judge_judgedpitch', 'max_overall_score', self.gf('django.db.models.fields.IntegerField')(default=5), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'JudgedPitch.overall_score'
        db.delete_column('judge_judgedpitch', 'overall_score')

        # Deleting field 'JudgedPitch.max_overall_score'
        db.delete_column('judge_judgedpitch', 'max_overall_score')
