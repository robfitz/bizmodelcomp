...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'JudgeInvitation.this_phase_only'
        db.alter_column('judge_judgeinvitation', 'this_phase_only_id', self.gf('django.db.models.fields.related.ForeignKey')(null=True, to=orm['competition.Phase']))


    def backwards(self, orm):
        
        # Changing field 'JudgeInvitation.this_phase_only'
        db.alter_column('judge_judgeinvitation', 'this_phase_only_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['competition.Phase']))
