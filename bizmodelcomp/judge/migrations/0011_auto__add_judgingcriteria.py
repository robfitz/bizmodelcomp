...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'JudgingCriteria'
        db.create_table('judge_judgingcriteria', (
            ('id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('prompt', self.gf('django.db.models.fields.CharField')(default='', max_length=500, blank=True)),
            ('max_points', self.gf('django.db.models.fields.IntegerField')(default=10)),
            ('is_text_feedback', self.gf('django.db.models.fields.BooleanField')(default=False)),
        ))
        db.send_create_signal('judge', ['JudgingCriteria'])


    def backwards(self, orm):
        
        # Deleting model 'JudgingCriteria'
        db.delete_table('judge_judgingcriteria')
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 2, 1, 15, 54, 32, 992025)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
