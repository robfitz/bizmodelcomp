...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'JudgeInvitation.has_sent_invite_email'
        db.delete_column('judge_judgeinvitation', 'has_sent_invite_email')

        # Adding field 'JudgeInvitation.has_received_invite_email'
        db.add_column('judge_judgeinvitation', 'has_received_invite_email', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Adding M2M table for field received_phase_judging_open_emails_from on 'JudgeInvitation'
        db.create_table('judge_judgeinvitation_received_phase_judging_open_emails_from', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('judgeinvitation', models.ForeignKey(orm['judge.judgeinvitation'], null=False)),
            ('phase', models.ForeignKey(orm['competition.phase'], null=False))
        ))
        db.create_unique('judge_judgeinvitation_received_phase_judging_open_emails_from', ['judgeinvitation_id', 'phase_id'])


    def backwards(self, orm):
        
        # Adding field 'JudgeInvitation.has_sent_invite_email'
        db.add_column('judge_judgeinvitation', 'has_sent_invite_email', self.gf('django.db.models.fields.BooleanField')(default=False), keep_default=False)

        # Deleting field 'JudgeInvitation.has_received_invite_email'
        db.delete_column('judge_judgeinvitation', 'has_received_invite_email')

        # Removing M2M table for field received_phase_judging_open_emails_from on 'JudgeInvitation'
        db.delete_table('judge_judgeinvitation_received_phase_judging_open_emails_from')
