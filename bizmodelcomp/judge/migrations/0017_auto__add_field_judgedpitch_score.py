...
from judge.models import JudgedPitch
...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'JudgedPitch.score'
        db.delete_column('judge_judgedpitch', 'score')
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2011, 3, 21, 1, 20, 48, 213795)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
