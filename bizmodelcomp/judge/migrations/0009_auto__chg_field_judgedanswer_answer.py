...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'JudgedAnswer.answer'
        db.alter_column('judge_judgedanswer', 'answer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['competition.PitchAnswer'], null=True))


    def backwards(self, orm):
        
        # Changing field 'JudgedAnswer.answer'
        db.alter_column('judge_judgedanswer', 'answer_id', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['competition.PitchAnswer']))
    ...
    models = {
        ...
        'competition.phase': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2010, 11, 24, 14, 19, 52, 21000)'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
